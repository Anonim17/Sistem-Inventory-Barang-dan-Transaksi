...
<div class="row justify-content-end">
    <div class="col-auto">
        <a href="{{ route('expenditure-transactions.create') }}" class="btn btn-sm btn-secondary mb-3">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <select class="form-control form-control-sm" id="order_by" name="order_by">
                        ...
                        <option value="picker" {{ $input['order_by'] === 'picker' ? 'selected' : '' }}>
                            Merk
                        </option>
            ...
            <table class="table table-bordered">
                <thead>
                    <tr>
                        ...
                        <th class="align-middle">Deskripsi Pengerjaan</th>
                ...
                <nav>
                    <ul class="pagination pagination-sm">
                        ...
                        <li class="page-item active">
                            <a href="{{ route('expenditure-transactions.index', ['page' => 1, 'order_by' => $input['order_by'], 'order_direction' => $input['order_direction'], 'keyword' => $input['keyword']]) }}" class="page-link">
                                1
                            </a>
                        </li>

                        @for ($i = 2; $i <= $pageTotal; $i++) @if ($i < 4) <li class="page-item">
                            <a class="page-link" href="{{ route('expenditure-transactions.index', ['page' => $i, 'order_by' => $input['order_by'], 'order_direction' => $input['order_direction'], 'keyword' => $input['keyword']]) }}">
                                {{ $i }}
                            </a>
                            </li>
                            @endif
                            ...
                            <li class="page-item">
                                <a class="page-link" href="{{ route('expenditure-transactions.index', ['page' => $input['page'] + 1, 'order_by' => $input['order_by'], 'order_direction' => $input['order_direction'], 'keyword' => $input['keyword']]) }}">
                                    >
                                </a>
                            </li>

                            <li class="page-item">
                                <a class="page-link" href="{{ route('expenditure-transactions.index', ['page' => $pageTotal, 'order_by' => $input['order_by'], 'order_direction' => $input['order_direction'], 'keyword' => $input['keyword']]) }}">
                                    >>
                                </a>
                            </li>
                            @else
                            <li class="page-item">
                                <a class="page-link" href="{{ route('expenditure-transactions.index', ['page' => 1, 'order_by' => $input['order_by'], 'order_direction' => $input['order_direction'], 'keyword' => $input['keyword']]) }}">
                                    << </a>
                            </li>
